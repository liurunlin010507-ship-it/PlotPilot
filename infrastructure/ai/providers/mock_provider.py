...
class MockProvider(LLMService):
    ...
    async def generate(self, prompt: Prompt, config: GenerationConfig) -> GenerationResult:
        ...
        if "宏观结构" in user_prompt or "结构框架" in user_prompt or "部-卷-幕" in user_prompt:
            ...
            content = json.dumps(
                {
                    ...
                    "worldbuilding": {
                        ...
                        "society": {"politics": "现代民主政体", "economy": "市场经济", "class_system": "现代社会阶层"},
                        "culture": {
                            "history": "当代都市文化",
                            "religion": "多元信仰并存",
                            "taboos": "遵守现代社会规范",
                    ...
                    "characters": [
                        {
                            ...
                            "relationships": [
                                {"target": "李四", "relation": "好友", "description": "多年好友，互相支持"}
                            ],
                        },
                        {
                            "name": "李四",
                            ...
                            "relationships": [
                                {"target": "张三", "relation": "好友", "description": "多年好友，提供专业建议"}
                            ],
                        },
                        {
                            "name": "王五",
                            ...
                            "relationships": [{"target": "张三", "relation": "竞争", "description": "文学奖竞争对手"}],
                        },
                    ]
                },
                ensure_ascii=False,
            ...
            # Default response
            content = json.dumps(
                {"characters": [], "locations": [], "style": "第三人称视角，轻松基调"}, ensure_ascii=False
            )

        # Create mock token usage
        token_usage = TokenUsage(input_tokens=len(prompt.user), output_tokens=len(content))
