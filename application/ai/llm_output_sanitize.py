...
_REDACTED_BLOCK = re.compile(
    rb"\x3credacted_reasoning\x3e.*?\x3c/redacted_reasoning\x3e".decode(),
    re.DOTALL,
)
_THINK_BLOCK = re.compile(
    rb"\x3cthink\x7c?\x3e.*?\x3c\x2fthink\x7c?\x3e".decode(),
    re.DOTALL,
)
_THINKING_BLOCK = re.compile(
    rb"\x3cthinking\x3e.*?\x3c\x2fthinking\x3e".decode(),
    re.DOTALL,
)
