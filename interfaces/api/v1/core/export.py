...
def get_export_service() -> ExportService:
    """获取导出服务"""
    return ExportService(novel_repository=get_novel_repository(), chapter_repository=get_chapter_repository())


@router.get("/novel/{novel_id}")
async def export_novel(
    novel_id: str, format: str = "epub", export_service: ExportService = Depends(get_export_service)
):
    """导出小说
...
async def export_chapter(
    chapter_id: str, format: str = "epub", export_service: ExportService = Depends(get_export_service)
):
    """导出章节
