...
async def benchmark():
    ...
    print("\n[1] GPU 模式测试...")
    try:
        service_gpu = LocalEmbeddingService(model_name="./.models/bge-small-zh-v1.5", use_gpu=True)
    ...
    print("\n[2] CPU 模式测试...")
    try:
        service_cpu = LocalEmbeddingService(model_name="./.models/bge-small-zh-v1.5", use_gpu=False)
