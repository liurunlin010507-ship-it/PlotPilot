...
def test_chapter_tension_score_default():
    """测试章节默认张力分数"""
    chapter = Chapter(id="test-ch-1", novel_id=NovelId("test-novel"), number=1, title="测试章节", content="测试内容")
...
def test_update_tension_score():
    """测试更新张力分数"""
    chapter = Chapter(id="test-ch-3", novel_id=NovelId("test-novel"), number=3, title="测试章节", content="测试内容")
...
def test_update_tension_score_validation():
    """测试张力分数验证"""
    chapter = Chapter(id="test-ch-4", novel_id=NovelId("test-novel"), number=4, title="测试章节", content="测试内容")
