...
def test_novel():
    ...
    response = client.post(
        "/api/v1/novels/",
        json={"novel_id": "test-novel-bible-ext", "title": "测试小说", "author": "测试作者", "target_chapters": 10},
    )
...
def test_bible(test_novel):
    ...
    response = client.post(
        ...
        json={"bible_id": "bible-1", "novel_id": "test-novel-bible-ext"},
    )
    assert response.status_code == 201
    return response.json()
...
class TestAddLocation:
    ...
    def test_add_location_success(self, test_bible):
        ...
        response = client.post(
            ...
            json={"location_id": "loc-1", "name": "皇宫", "description": "金碧辉煌的皇宫", "location_type": "building"},
        )
    ...
    def test_add_multiple_locations(self, test_bible):
        ...
        response = client.post(
            "/api/v1/bible/novels/test-novel-bible-ext/bible/locations",
            json={"location_id": "loc-2", "name": "森林", "description": "神秘的森林", "location_type": "natural"},
        )
        assert response.status_code == 200
        data = response.json()
...
class TestAddStyleNote:
    ...
    def test_add_style_note_success(self, test_bible):
        ...
        response = client.post(
            ...
            json={"note_id": "style-1", "category": "tone", "content": "整体风格偏向轻松幽默"},
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_add_multiple_style_notes(self, test_bible):
        ...
        response = client.post(
            "/api/v1/bible/novels/test-novel-bible-ext/bible/style-notes",
            json={"note_id": "style-2", "category": "pacing", "content": "节奏要快，避免拖沓"},
        )
        assert response.status_code == 200
        data = response.json()
...
class TestBulkUpdateBible:
    ...
    def test_bulk_update_success(self, test_bible):
        ...
        response = client.put(
            ...
            json={
                "characters": [
                    {"id": "char-1", "name": "张三", "description": "主角", "relationships": []},
                    {"id": "char-2", "name": "李四", "description": "配角", "relationships": ["char-1"]},
                ],
                "world_settings": [
                    {"id": "setting-1", "name": "魔法系统", "description": "基于元素的魔法", "setting_type": "rule"}
                ],
                "locations": [
                    {"id": "loc-1", "name": "皇宫", "description": "金碧辉煌的皇宫", "location_type": "building"}
                ],
                "timeline_notes": [
                    {
                        "id": "timeline-1",
                ...
                "style_notes": [{"id": "style-1", "category": "tone", "content": "整体风格偏向轻松幽默"}],
            },
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_bulk_update_partial(self, test_bible):
        ...
        response = client.put(
            "/api/v1/bible/novels/test-novel-bible-ext/bible",
            json={
                "characters": [{"id": "char-1", "name": "张三", "description": "主角", "relationships": []}],
                "world_settings": [],
                "locations": [],
                "timeline_notes": [],
                "style_notes": [],
    ...
    def test_bulk_update_replaces_existing(self, test_bible):
        ...
        client.post(
            ...
            json={"character_id": "old-char", "name": "旧人物", "description": "将被替换"},
        )
        ...
        response = client.put(
            "/api/v1/bible/novels/test-novel-bible-ext/bible",
            json={
                "characters": [{"id": "new-char", "name": "新人物", "description": "新的人物", "relationships": []}],
                "world_settings": [],
                "locations": [],
                "timeline_notes": [],
                "style_notes": [],
    ...
    def test_bulk_update_bible_not_found(self, test_novel):
        ...
        response = client.put(
            "/api/v1/bible/novels/test-novel-bible-ext/bible",
            json={"characters": [], "world_settings": [], "locations": [], "timeline_notes": [], "style_notes": []},
        )
        assert response.status_code == 404
