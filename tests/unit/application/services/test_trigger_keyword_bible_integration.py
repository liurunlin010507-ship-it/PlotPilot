...
def test_trigger_keywords_inject_matching_world_settings():
    ...
    sword_setting = _make_world_setting(
        name="刃尘剑法", setting_type="战斗技能", description="以气息凝刃，每式蕴含一种元素属性"
    )
    other_setting = _make_world_setting(name="皇都布局", setting_type="地点", description="帝国首都的建筑格局")
...
def test_unknown_trigger_falls_back_and_matches_by_self():
    ...
    cb = _make_context_builder()
    special_setting = _make_world_setting(name="神秘契约", setting_type="神秘契约", description="一种特殊的血脉盟约")
