...
def test_chapter_creation_with_content():
    """测试创建带内容的章节"""
    chapter = Chapter(id="chapter-1", novel_id=NovelId("novel-1"), number=1, title="第一章", content="这是章节内容")
...
def test_chapter_content_property():
    """测试 content 属性"""
    chapter = Chapter(id="chapter-1", novel_id=NovelId("novel-1"), number=1, title="第一章", content="测试内容")
