...
def test_voice_api():
    ...
    sample_response = requests.post(f"{BASE_URL}/novels/{novel_id}/voice/samples", json=sample_data)
    ...
    sample_response_2 = requests.post(f"{BASE_URL}/novels/{novel_id}/voice/samples", json=sample_data_2)
    ...
    invalid_data = {"ai_original": "", "author_refined": "作者改稿", "chapter_number": 1, "scene_type": "action"}

    invalid_response = requests.post(f"{BASE_URL}/novels/{novel_id}/voice/samples", json=invalid_data)
